package :ruby_enterprise do
  ...
  #seems to be an internal ruby forge id that changes as the version changes - check this in the dl url
  ruby_forge_path_dl_num = '57097'
  ...
  source "http://rubyforge.org/frs/download.php/#{ruby_forge_path_dl_num}/ruby-enterprise-#{version}.tar.gz" do
